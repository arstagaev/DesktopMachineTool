...
fun Seekbar(
    ...
    Box(
        ...
        Canvas(
                ...
                .pointerInput(Unit) {
                    detectDragGestures(
                        ...
                        onDragEnd = {
                            ...
                            print("onDragEnd ${dragProgress.value}")
                        },
                        onDrag = { change: PointerInputChange, dragAmount ->
                            ...
                            print("onDrag ${change.position.x}")
                        }
                    )
                }
                .pointerInput(Unit) {
            ...
            val progressFloat = (position.toDouble() / duration.value.toDouble()).toFloat()
